...
set feedURL	= "${NUXEO_URL}/ucldc_collection_26899.atom"
...
set updateFile	= "${base}/LastUpdate/lastFeedUpdate_26899-m5k40smm"
set log		= "${base}/logs/stage-26899-${profile}_${date}.log"
