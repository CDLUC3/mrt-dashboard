...
class VersionControllerTest < ActionController::TestCase
  ...
  test "version 0 redirects to latest" do
    ...
    # we shouldn't need to urlencode the 2nd part, but we do
    assert_redirected_to(:action => :index, :object => urlencode("ark:/99999/fk40k2sqf"), :version=>1)
  end

  test "version 0 download redirects to latest" do
    get(:download, {:object => "ark:/99999/fk40k2sqf", :version=>0}, {:uid => "anonymous"})
    assert_redirected_to(:action => :download, :object => urlencode("ark:/99999/fk40k2sqf"), :version=>1)
  end
